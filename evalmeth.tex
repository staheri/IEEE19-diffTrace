...
\caption{Average Tracing Overhead on NPB applications - Input: B}
...
\caption{ Average Tracing Overhead on NPB applications - Input: C}
...
\caption{  Average Required Bandwidth per core(kB/s) for NPB applications - Input: B}
...
\caption{ Average Required Bandwidth per core(kB/s) for NPB applications - Input: C}
...
\caption{ Average Compression Ratio of ParLOT for NPB applications - Input: B}
...
\caption{ Average Compression Ratio of ParLOT for NPB applications - Input: C}
