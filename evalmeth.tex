...
\begin{figure}[t]
\centering
\includegraphics[width=3.8in,height=2.1in]{figs.comet.newMed/comet_chartAvg_sd_B_p3_5.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=3.8in,height=2.1in]{figs.comet.newMed/comet_chartAvg_sd_C_p3_5.png}
