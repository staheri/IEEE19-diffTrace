...
We compare our \parlot tool, which is based on \pin 3.5, with \callgrind 3.13. \parlot was compiled with gcc 4.9.2 using \pin 's make system and \callgrind with Valgrind's make system. We created the following versions of \parlot to evaluate different aspects of its design.
