...
Therefore, also works for higher bw codes than the ones we tested. 

 \hl{ Basic code blocks within program executables  dynamically instrumented before being executed and collected data getting compressed on-the-fly during runtime. Following subsections discuss different aspects of ParLOT's design.}
