...
It is clear that we cannot collect everything that must be
collected to detect all possible bug classes in HPC ranging
...
...how far we can go via fn call ercording .. calling context pairs... shine light..other tool attach!..XSXg
