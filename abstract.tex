...
two HPC platforms.
%
Our experiments show that parlot can produce full function call trace with only 0.85 kB required bandwidth while slowing down applications only by as low as 38\%. %-->GG:no figs in abstract !(fig \ref{sd.pin.cg}).
%
%- 
